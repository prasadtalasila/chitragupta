# Dossier: dt-overview/staleness-chapter

The working state that produced `content/drafts/dt-overview/staleness-chapter.md` -- what a later
session needs in order to revise it without re-running the drafting
pipeline. Genre: textbook-chapter.
...
restore it with:
    ...
    python -m chitragupta.draft dossier export dt-overview/staleness-chapter
