# Multi-source synthesis: content/drafts/dt-overview/survey.md
...
Measured at the **paragraph**, recorded as `survey` in this draft's dossier.
...
- 21 paragraphs, of which 14 cite nothing
- 3 cite two or more sources
- 4 rest on a single source (0 declared, 4 not)
- **57%** of the paragraphs that cite at all rest on one source

## Units

- line 5: `sample_dt_overview_2024`
- line 22: `sample_dt_sync_2023`
- line 46: `sample_ml_anomaly_2023`
- line 58: `sample_std_interop_2021`
