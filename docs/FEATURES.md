...
| Docker | two images: one that installs the Pandoc/TeX toolchain when you lack root, one that hosts a Claude Code agent with the published package | [RUNNING-WITH-DOCKER.md](RUNNING-WITH-DOCKER.md) |
