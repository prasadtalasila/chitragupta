# Verbatim scan: content/drafts/dt-overview/staleness-chapter.md
...
- Command: `python -m chitragupta.review verbatim scan content/drafts/dt-overview/staleness-chapter.md --min-run 8 --gap 1 --write`
- chitragupta 6.60.2
