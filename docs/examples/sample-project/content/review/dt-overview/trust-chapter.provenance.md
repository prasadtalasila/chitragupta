# Citation provenance: content/drafts/dt-overview/trust-chapter.tex
...
#### Line 55 -- `[@sample_dt_overview_2024]` (42% match)
...
#### Line 26 -- `[@sample_dt_sync_2023]` (46% match)
...
#### Line 45 -- `[@sample_ml_anomaly_2023]` (66% match)
...
#### Line 31 -- `[@sample_dt_factory_2022]` (74% match)
...
#### Line 38 -- `[@sample_dt_factory_2022]` (74% match)
