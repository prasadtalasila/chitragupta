# Multi-source synthesis: content/drafts/dt-overview/staleness-tutorial.md
...
- Command: `python -m chitragupta.review synthesis content/drafts/dt-overview/staleness-tutorial.md --write`
- chitragupta 6.60.3

## How to read this

Measured at the **document**, recorded as `tutorial` in this draft's dossier.
...
- 1 documents, of which 0 cite nothing
- 1 cite two or more sources
- 0 rest on a single source (0 declared, 0 not)
- **0%** of the documents that cite at all rest on one source
