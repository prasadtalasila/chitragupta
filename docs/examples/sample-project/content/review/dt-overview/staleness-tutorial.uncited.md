# Uncited prose: content/drafts/dt-overview/staleness-tutorial.md
...
- Command: `python -m chitragupta.review uncited content/drafts/dt-overview/staleness-tutorial.md --write`
- chitragupta 6.60.3

## How to read this

Read under a genre recorded as `tutorial` in this draft's dossier, where uncited prose is **ordinary**.
...
**18** of 20 claim-bearing sentences carry no citation, **18** of them in a block that cites nothing.
