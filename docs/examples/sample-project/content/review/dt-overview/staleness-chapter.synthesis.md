# Multi-source synthesis: content/drafts/dt-overview/staleness-chapter.md
...
- Command: `python -m chitragupta.review synthesis content/drafts/dt-overview/staleness-chapter.md --write`
- chitragupta 6.61.0

## How to read this

Measured at the **section**, recorded as `textbook-chapter` in this draft's dossier.
...
- 10 sections, of which 8 cite nothing
- 2 cite two or more sources
- 0 rest on a single source (0 declared, 0 not)
- **0%** of the sections that cite at all rest on one source

## Units

Every unit that cites at all cites more than one source.
