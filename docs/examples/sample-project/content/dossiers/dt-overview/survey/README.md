# Dossier: dt-overview/survey

The working state that produced `content/drafts/dt-overview/survey.md` -- what a later
...
restore it with:
    ...
    python -m chitragupta.draft dossier export dt-overview/survey
