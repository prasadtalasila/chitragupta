...
`examples/sample-project/content/specs/twin-basics/` holds a signed
two-chapter outline (`spec.md`), its sign-off record (`signoff.md`), and
one accepted unit (`units/ch-staleness.json`) whose authored chapter
sits at `content/drafts/twin-basics/ch-staleness.md` -- with the second
