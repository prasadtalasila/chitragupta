...
chitragupta/review/                the review layer -- one command, `python -m chitragupta.review <aid>`, five aids
  __init__.py               the layer's shared output contract -- report path (content/review/,
                          ...
                          write-md-then-render routine all five aids use. No timestamp, so a
